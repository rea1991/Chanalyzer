...
private:
	...
	typedef CGAL::Regular_triangulation_vertex_base_3<_K>                       _Vertex;
	...
	typedef _K::Point_3                                         _Point3;
	typedef _K::Weighted_point_3                                _Weighted_point;
	
	typedef _tds::Vertex_iterator                               _Vertex_iterator;
    typedef _tds::Cell_iterator                                 _Cell_iterator;
	...
	typedef _tds::Vertex_handle                                 _Vertex_handle;
